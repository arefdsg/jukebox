...
vqvae = Hyperparams(
    ...
    restore_vqvae=REMOTE_PREFIX + 'jukebox/models/1b/vqvae.pth.tar',
)
...
upsampler_level_0 = Hyperparams(
    level=0,
    restore_prior=REMOTE_PREFIX + 'jukebox/models/1b/prior_level_0.pth.tar'
)
...
upsampler_level_1 = Hyperparams(
    level=1,
    cond_res_scale=True,
    restore_prior=REMOTE_PREFIX + 'jukebox/models/1b/prior_level_1.pth.tar'
)
...
prior_5b = Hyperparams(
    ...
    prime_loss_fraction=0.0,
    merged_decoder=True,
    restore_prior=REMOTE_PREFIX + 'jukebox/models/1b/prior_level_2.pth.tar',
    fp16_params=True,
)
